...
struct timer_list slow_led_timer;
...
static int slow_led_flag = 1;
static int slow_led_count = 0;
void slow_led_expire(unsigned long nothing)
{
	if (slow_led_flag)
	{
	...
	if (slow_led_count < 10)
	{
		/* turn on the only led in wr703 1.0, by zcf, 20110825 */

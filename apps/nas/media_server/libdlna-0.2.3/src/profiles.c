...
/* add more A/V format support. by HouXB, 28Mar11 */
extern dlna_registered_profile_t dlna_profile_image_bmp;
extern dlna_registered_profile_t dlna_profile_image_gif;
extern dlna_registered_profile_t dlna_profile_image_tif;

extern dlna_registered_profile_t dlna_profile_audio_aif;
extern dlna_registered_profile_t dlna_profile_audio_mp2;
extern dlna_registered_profile_t dlna_profile_audio_ogg;
extern dlna_registered_profile_t dlna_profile_audio_flac;
extern dlna_registered_profile_t dlna_profile_audio_aiff;
extern dlna_registered_profile_t dlna_profile_audio_wav;

extern dlna_registered_profile_t dlna_profile_av_avi;
extern dlna_registered_profile_t dlna_profile_av_vob;
extern dlna_registered_profile_t dlna_profile_av_m4v;
extern dlna_registered_profile_t dlna_profile_av_mkv;
extern dlna_registered_profile_t dlna_profile_av_mov;
...
dlna_register_all_media_profiles (dlna_t *dlna)
{
	...
	/* add more image format support. by HouXB, 28Mar11 */
	dlna_register_profile (dlna, &dlna_profile_image_bmp);
	dlna_register_profile (dlna, &dlna_profile_image_gif);
	dlna_register_profile (dlna, &dlna_profile_image_tif);
	...
	/* add more audio format support. by HouXB, 29Mar11 */
	dlna_register_profile (dlna, &dlna_profile_audio_aif);
	dlna_register_profile (dlna, &dlna_profile_audio_mp2);
	dlna_register_profile (dlna, &dlna_profile_audio_ogg);
	dlna_register_profile (dlna, &dlna_profile_audio_flac);	
	dlna_register_profile (dlna, &dlna_profile_audio_aiff);
	...
	/* add more vedio format support. by HouXB, 28Mar11 */
	dlna_register_profile (dlna, &dlna_profile_av_avi);
	dlna_register_profile (dlna, &dlna_profile_av_vob);
	dlna_register_profile (dlna, &dlna_profile_av_m4v);
	dlna_register_profile (dlna, &dlna_profile_av_mkv);	
	dlna_register_profile (dlna, &dlna_profile_av_mov);
}
...
dlna_profile_t *
dlna_guess_media_profile2 (dlna_t *dlna, const char *filename)
{
...
{
	AVFormatContext *ctx;	/* sizeof(AVFormatContext) is 3968. by HouXB, 08Oct10 */
	dlna_registered_profile_t *p;
	dlna_profile_t *profile = NULL;
							...
							dlna_profile_t *p)
{
	...
	if (!strcmp(p->id, "wav"))
	{
		sprintf(dlna_info, "%s", ":DLNA.ORG_OP=01");
	}
	else
	{
